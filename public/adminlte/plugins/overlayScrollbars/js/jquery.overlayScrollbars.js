...
(function (global, factory) {
    ...
    function(window, document, undefined, framework) {
        ...
        var COMPATIBILITY = {
             ...
             * @apiSuccesss {Number|number} The current window width in pixel.
             */
            wW: function() {
             ...
             * @apiSuccesss {Number|number} The current window height in pixel.
             */
            wH: function() {
             ...
             * @apiSuccesss {MutationObserver|*|undefined} The MutationsObserver Object or undefined.
             */
            mO: function() {
             ...
             * @apiSuccesss {MutationObserver|*|undefined} The ResizeObserver Object or undefined.
             */
            rO: function() {
             ...
             * @apiSuccesss {*|Function} The RequestAnimationFrame method or it's corresponding polyfill.
             */
            rAF: function() {
             ...
             * @apiSuccesss {*|Function} The CancelAnimationFrame method or it's corresponding polyfill.
             */
            cAF: function() {
             ...
             * @apiSuccesss {number} The current time.
             */
            now: function() {
             ...
             * @apiParam event The event of which the propagation shall be stoped.
             */
            stpP: function(event) {
             ...
             * @apiParam event The event of which the default action shall be prevented.
             */
            prvD: function(event) {
             ...
             * @apiParam event The mouse event of which the pageX and pageX shall be got.
             * @apiSuccesss {{x: number, y: number}} x = pageX value, y = pageY value.
             */
            page: function(event) {
             ...
             * @apiParam event The mouse event of which the clicked button shal be got.
             * @apiSuccesss {number} The number of the clicked mouse button. (0 : none | 1 : leftButton | 2 : middleButton | 3 : rightButton)
             */
            mBtn: function(event) {
             ...
             * @apiParam item The item of which the position in the array shall be determined.
             * @apiParam arr The array.
             * @apiSuccesss {number} The zero based index of the item or -1 if the item isn't in the array.
             */
             ...
             * @apiParam arr The potential array.
             * @apiSuccesss {boolean} True if the given value is a array, false otherwise.
             */
            isA: function(arr) {
             ...
             * @apiParam obj The object of which the type shall be determined.
             * @apiSuccesss {string} The type of the given object.
             */
            type: function(obj) {
                if (obj === undefined)
                    return obj + "";
             ...
             * @apiParam propName The unprefixed CSS property name.
             * @apiSuccesss {string|null} The vendor-prefixed CSS property or null if the browser doesn't support the given CSS property.
        ...
        var INSTANCES = (function() {
             ...
             * @apiParam target The target to which the instance shall be registered / from which the instance shall be unregistered / the instance shall be got
             * @apiParam instance The instance.
             * @apiSuccesss {*|void} Returns the instance from the given target.
             */
        ...
        var PLUGIN = (function() {
            ...
            var _pluginsOptions = (function() {
                ...
                return {
                     ...
                     * @apiParam obj The object which shall be validated.
                     * @apiParam template The template which defines the allowed values and types.
                     * @apiParam writeErrors True if errors shall be logged to the console.
                     * @apiParam usePreparedValues True if the validated main values shall be returned in the validated object, false otherwise.
                     * @apiParam keepForeignProps True if properties which aren't in the template shall be added to the validated object, false otherwise.
                     * @apiSuccesss {{}} A object which contains only the valid properties of the passed original object.
                     */
            ...
            function OverlayScrollbarsAutoUpdateLoop(globals) {
                 ...
                 * @apiParam instance The instance which shall be updated in a loop automatically.
                 */
             ...
             * @apiParam pluginTargetElement The element from which the scrollbars shall be hidden.
             * @apiParam options The custom options.
             * @apiParam extensions The custom extensions.
             * @apiParam globals
             * @apiParam autoUpdateLoop
             * @apiSuccesss {*}
             * @constructor
             */
            function OverlayScrollbarsInstance(pluginTargetElement, options, extensions, globals, autoUpdateLoop) {
                 ...
                 * @apiParam element The element to which the event listener shall be applied.
                 * @apiParam eventNames The name(s) of the event listener.
                 * @apiParam listener The listener method which shall be called.
                 */
                 ...
                 * @apiParam element The element from which the event listener shall be removed.
                 * @apiParam eventNames The name(s) of the event listener.
                 * @apiParam listener The listener method which shall be removed.
                 */
                 ...
                 * @apiParam targetElement The element to which the resize observer shall be applied.
                 * @apiParam onElementResizedCallback The callback which is fired every time the resize observer registers a size change.
                 */
                 ...
                 * @apiParam targetElement The element to which the target resize observer is applied.
                 */
                 ...
                 * @apiParam destroy Indicates whether the events shall be added or removed.
                 */
                 ...
                 * @apiParam event The select start event.
                 */
                 ...
                 * @apiSuccesss {boolean} True if the min width or min height has changed, false otherwise.
                 */
                 ...
                 * @apiParam oldCassNames The old ClassName string.
                 * @apiParam newClassNames The new ClassName string.
                 * @apiSuccesss {boolean} True if the class names has really changed, false otherwise.
                 */
                 ...
                 * @apiParam mutation The mutation which shall be checked.
                 * @apiSuccesss {boolean} True if the mutation is from a unknown element, false otherwise.
                 */
                 ...
                 * @apiSuccesss {boolean} True if the content size was changed, false otherwise.
                 */
                 ...
                 * @apiParam propertyName The CSS property name.
                 * @apiSuccesss {boolean} True if the property is affecting the content scroll size, false otherwise.
                 */
                 ...
                 * @apiParam hostSizeChanged True if this method was called due to a host size change.
                 * @apiParam contentSizeChanged True if this method was called due to a content size change.
                 * @apiParam force True if every property shall be updated and the cache shall be ignored.
                 * @apiParam preventSwallowing True if this method shall be executed event if it could be swallowed.
                 */
                 ...
                 * @apiParam newOptions The object which contains the new options.
                 */
                 ...
                 * @apiParam destroy Indicates whether the DOM shall be build or destroyed.
                 */
                 ...
                 * @apiParam isHorizontal True if the target scrollbar is the horizontal scrollbar, false if the target scrollbar is the vertical scrollbar.
                 */
                 ...
                 * @apiParam isHorizontal True if the horizontal scrollbar is the target, false if the vertical scrollbar is the target.
                 * @apiParam shallBeVisible True if the scrollbar shall be shown, false if hidden.
                 * @apiParam canScroll True if the scrollbar is scrollable, false otherwise.
                 */
                 ...
                 * @apiParam shallBeVisible True if the scrollbars shall be autoshown (only the case if they are hidden by a autohide), false if the shall be auto hidden.
                 * @apiParam delayfree True if the scrollbars shall be hidden without a delay, false or undefined otherwise.
                 */
                 ...
                 * @apiParam isHorizontal True if the horizontal scrollbar handle shall be refreshed, false if the vertical one shall be refreshed.
                 */
                 ...
                 * @apiParam isHorizontal True if the horizontal scrollbar handle shall be refreshed, false if the vertical one shall be refreshed.
                 * @apiParam scrollOrTransition The scroll position of the given scrollbar axis to which the handle shall be moved or a boolean which indicates whether a transition shall be applied. If undefined or boolean if the current scroll-offset is taken. (if isHorizontal ? scrollLeft : scrollTop)
                 */
                 ...
                 * @apiParam isTrack True if the track element is the target, false if the handle element is the target.
                 * @apiParam value True for interactivity false for no interactivity.
                 */
                 ...
                 * @apiParam isHorizontal True if the horizontal scrollbar vars shall be accessed, false if the vertical scrollbar vars shall be accessed.
                 * @apiSuccesss {{wh: string, WH: string, lt: string, _wh: string, _lt: string, t: *, h: *, c: {}, s: *}}
                 */
                 ...
                 * @apiParam name The name of the target which shall be called.
                 * @apiParam args The args with which the callback shall be called.
                 */
                 ...
                 * @apiParam targetCSSObject The css object to which the values shall be applied.
                 * @apiParam prefix The prefix of the "top, right, bottom, left" css properties. (example: 'padding-' is a valid prefix)
                 * @apiParam values A array of values which shall be applied to the "top, right, bottom, left" -properties. The array order is [top, right, bottom, left].
                 ...
                 * @apiParam element The element from which the transition string shall be returned.
                 * @apiSuccesss {string} The CSS transition string from the given element.
                 */
                 ...
                 * @apiSuccesss {{x: number, y: number}} The scale of the host-element.
                 */
                 ...
                 * @apiParam o The object which shall be checked.
                 * @apiSuccesss {boolean} True the given object is a HTMLElement, false otherwise.
                 */
                 ...
                 * @apiParam a1 The first array which shall be compared.
                 * @apiParam a2 The second array which shall be compared.
                 * @apiSuccesss {Array} The differences between the two arrays.
                 */
                 ...
                 * @apiParam value The value which shall be parsed.
                 * @apiParam toFloat Indicates whether the number shall be parsed to a float.
                 */
                 ...
                 * @apiSuccesss {{cursorRow: Number, cursorCol, rows: Number, cols: number, wRow: number, pos: number, max : number}} or undefined if not supported.
                 */
                 ...
                 * @apiSuccesss {boolean} True if native overlay scrollbars are active, false otherwise.
                 */
                 ...
                 * @apiSuccesss {*} TextareaCover if target element is textarea else the ContentElement.
                 */
                 ...
                 * @apiParam classesOrAttrs The class of the div as string or a object which represents the attributes of the div. (The class attribute can also be written as "className".)
                 * @apiParam content The content of the div as string.
                 * @apiSuccesss {string} The concated string which represents a HTML div and its content.
                 */
                 ...
                 * @apiParam obj The object from which the property value shall be got.
                 * @apiParam path The property of which the value shall be got.
                 * @apiSuccesss {*} Returns the value of the searched property or undefined of the property wasn't found.
                 */
                 ...
                 * @apiParam obj The object from which the property value shall be set.
                 * @apiParam path The property of which the value shall be set.
                 * @apiParam val The value of the property which shall be set.
                 */
                 ...
                 * @apiParam current The first value which shall be compared.
                 * @apiParam cache The second value which shall be compared.
                 * @apiParam force If true the returned value is always true.
                 * @apiSuccesss {boolean} True if both variables aren't equal or some of them is undefined or when the force parameter is true, false otherwise.
                 */
                 ...
                 * @apiParam current The first object which shall be compared.
                 * @apiParam cache The second object which shall be compared.
                 * @apiParam prop1 The name of the first property of the objects which shall be compared.
                 * @apiParam prop2 The name of the second property of the objects which shall be compared.
                 * @apiParam force If true the returned value is always true.
                 * @apiSuccesss {boolean} True if both variables aren't equal or some of them is undefined or when the force parameter is true, false otherwise.
                 */
                 ...
                 * @apiParam current The first object with four properties.
                 * @apiParam cache The second object with four properties.
                 * @apiSuccesss {boolean} True if both objects aren't equal or some of them is undefined, false otherwise.
                 */
                 ...
                 * @apiParam el The root element from which the selector shall be valid.
                 * @apiParam selector The selector of the searched element.
                 * @apiSuccesss {*} The first element which is a child of the given element and matches the givens selector.
                 */
                 ...
                 * @apiParam newOptions If new options are given, then the new options will be set, if new options aren't given (undefined or a not a plain object) then the current options will be returned.
                 * @apiParam value If new options is a property path string, then this value will be used to set the option to which the property path string leads.
                 * @apiSuccesss {*}
                 */
                 ...
                 *
                 * @apiParam duration The duration of the scroll animation, OR a jQuery animation configuration object.
                 * @apiParam easing The animation easing.
                 * @apiParam complete The animation complete callback.
                 * @apiSuccesss {{
                 ...
                 * @apiSuccesss {*} The current OverlayScrollbars instance (for chaining).
                 */
                 ...
                 * @apiParam elementName The name of the element which shall be returned.
                 * @apiSuccesss {{target: *, host: *, padding: *, viewport: *, content: *, scrollbarHorizontal: {scrollbar: *, track: *, handle: *}, scrollbarVertical: {scrollbar: *, track: *, handle: *}, scrollbarCorner: *} | *}
                 */
                 ...
                 * @apiParam stateProperty A specific property from the state object which shall be returned.
                 * @apiSuccesss {{widthAuto, heightAuto, overflowAmount, hideOverflow, hasOverflow, contentScrollSize, viewportSize, hostSize, autoUpdate} | *}
                 */
                 ...
                 * @apiParam extName The name of the extension from which the instance shall be got.
                 * @apiSuccesss {{}} The instance of the extension with the given name or undefined if the instance couldn't be found.
                 */
                 ...
                 * @apiParam extName The name of the extension which shall be added.
                 * @apiParam extensionOptions The extension options which shall be used.
                 * @apiSuccesss {{}} The instance of the added extension or undefined if the extension couldn't be added properly.
                 */
                 ...
                 * @apiParam extName The name of the extension which shall be removed.
                 * @apiSuccesss {boolean} True if the extension was removed, false otherwise e.g. if the extension wasn't added before.
                 */
                 ...
                 * @apiParam targetElement The element to which the plugin shall be applied.
                 * @apiParam options The initial options of the plugin.
                 * @apiParam extensions The extension(s) which shall be added right after the initialization.
                 * @apiSuccesss {boolean} True if the plugin was successfully initialized, false otherwise.
                 */
             ...
             * @apiParam pluginTargetElements The elements to which the Plugin shall be initialized.
             * @apiParam options The custom options with which the plugin shall be initialized.
             * @apiParam extensions The extension(s) which shall be added right after initialization.
             * @apiSuccesss {*}
             */
             ...
             * @apiParam newDefaultOptions The object with which the default options shall be extended.
             */
             ...
             * @apiParam extensionName The name of the extension which shall be registered, unregistered or returned.
             * @apiParam extension A function which generates the instance of the extension or anything other to remove a already registered extension.
             * @apiParam defaultOptions The default options which shall be used for the registered extension.
             */
        ...
        if(JQUERY && JQUERY.fn) {
             ...
             * @apiParam options The initial options for the construction of the plugin. To initialize the plugin, this option has to be a object! If it isn't a object, the instance(s) are returned and the plugin wont be initialized.
             * @apiParam extensions The extension(s) which shall be added right after initialization.
             * @apiSuccesss {*} After initialization it returns the jQuery element array, else it returns the instance(s) of the elements which are selected.
             */
