...
class Lead extends Model
{
    ...
    ***********************************************************************************/
    ...
    {
        return $this->belongsTo('App\Models\CRM\LeadStatus', 'lead_status_id');
    }

    public function meetings()
    {
        return $this->hasMany('App\Models\CRM\Meeting');
    }
    ...
    {
        return $this->hasMany('App\Models\CRM\LeadContract');
    }
    /*** helpers
    ***********************************************************************************/
