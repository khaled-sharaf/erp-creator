...
use Modules\HR\Http\Requests\UserRequest;
...
class UserController extends Controller
{
    ...
    {
        $users = User::with('jobTitle');

        if($request->has('department_name'))
        {
            $users->whereHas('department',function($q)use($request){
    ...
    // public function store(Request $request)
    {
        // dd($request->all());
        // $request->validated();
        $userData = $request->except(['password_confirmation', 'create_again']);
        ...
        /*================================================*/
        $documentsDB = null;
        // $userData['documents'] =  json_decode($userData['documents'], true);
    ...
    public function update(UserRequest $request, $id)
    {
        ...
        $userData = $request->except(['password_confirmation', 'create_again', 'deletedDocuments']);
