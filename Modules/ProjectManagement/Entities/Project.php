...
class Project extends Model
{
    ...
    ***********************************************************************************/
    ...
    {
        return $this->hasMany('Modules\ProjectManagement\Entities\ProjectHasPlatform', 'project_id');
    }


    public function contract()
    {
        return $this->belongsTo('Modules\CRM\Entities\LeadContract', 'lead_contract_id');
    }
