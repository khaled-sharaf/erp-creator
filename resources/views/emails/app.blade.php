...
<head>
    ...
    {{-- {!! include public_path('emails-style/main.css') !!} --}}
    <style>
        body {
            margin: 0;
            font-size: 1rem;
    ...
    <div class="email-wrapper">
        <div class="container">
            ...
            <div class="main-header">
                <div class="logo">
                    {{ Html::image($settings['logo'], 'Logo', ['class' => 'img']) }}
                </div>
            ...
            <div class="main-content">
                ...
                <div class="header-content">
                    <div class="background-message">
                        <div class="image">
                            <img src="{{ url('admin/images/logo-message.png') }}">
                        </div>
                    </div>
                </div>
                {{-- ./header content ================================================= --}}
            ...
            <div class="main-footer">
                ...
                <div class="copyright">
                    ...
                    <a href="#" class="mark">{{ $settings['app_name_long'] }}</a>,
                    All rights reserved.
                </div>
