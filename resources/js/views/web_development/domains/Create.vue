    ...
    <div>
        ...
        <section class="content">
            <div class="container-fulid">
                <div class="card">
                    <!-- form -->
                    <form @submit.prevent="createDomain()" class="global-form-handel">
                        <!-- card-body -->
                        <div class="card-body">
...
export default {
    ...
    mounted() {
        this.breadcrumb = [
            ...
            {label: this.$t('global.create') + ' ' + this.$t('sidebar.new_domain'), active: true},
        ]
    },
    beforeRouteEnter (to, from, next) {
        next(vm => {
            to.meta.title = vm.$t('global.create') + ' ' + vm.$t('sidebar.new_domain')
        })
    }
}
</script>
