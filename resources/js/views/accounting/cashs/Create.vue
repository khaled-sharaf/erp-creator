    ...
    <div>
        ...
        <section class="content">
            <div class="container-fulid">
                <div class="card">
                    <!-- form -->
                    <form @submit.prevent="createCash()" class="global-form-handel">
                        <!-- card-body -->
                        <div class="card-body">
...
export default {
    ...
    mounted() {
        this.breadcrumb = [
            ...
            {label: this.$t('global.create') + ' ' + this.$t('sidebar.new_cash'), active: true},
        ]
    },
    beforeRouteEnter (to, from, next) {
        next(vm => {
            to.meta.title = vm.$t('global.create') + ' ' + vm.$t('sidebar.new_cash')
        })
    }
}
</script>
