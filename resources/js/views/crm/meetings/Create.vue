            ...
            <div class="container-fulid">
                <div class="card">
                    ...
                    <form @submit.prevent="createMeeting()" class="global-form-handel">
                        <!-- card-body -->
                        <div class="card-body">
                            <form-model typeForm="create" :form="form" :formReset="formReset"></form-model>
                        </div>
                        <!-- ./card-body -->
...
export default {
    ...
    mounted() {
        this.breadcrumb = [
            ...
            {label: this.$t('global.create') + ' ' + this.$t('sidebar.new_meeting'), active: true},
        ]
    },
    beforeRouteEnter (to, from, next) {
        next(vm => {
            to.meta.title = vm.$t('global.create') + ' ' + vm.$t('sidebar.new_meeting')
        })
    }
}
</script>
