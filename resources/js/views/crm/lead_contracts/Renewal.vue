            ...
            <div class="container-fulid">
                <div class="card">
                    ...
                    <form @submit.prevent="updateLead()" class="global-form-handel">
                        <!-- card-body -->
                        <div class="card-body">
                            <form-model typeForm="renewal" :form="form"></form-model>
                        </div>
                        <!-- ./card-body -->
                        ...
                        <div class="card-footer">
                            ...
                            >
                            Renew
                            <span v-if="form.busy" class="btn-loader"><img :src="$domain + 'admin/images/btn-loader.gif'"></span>
                        </button>
                        </div> <!-- ./card-footer -->
...
export default {
    ...
    mounted() {
        this.breadcrumb = [
            ...
            {label: this.$t('sidebar.renewal_lead_contract'), active: true},
        ]
    },
    beforeRouteEnter(to, from, next) {
        next(vm => {
            to.meta.title = vm.$t('sidebar.renewal_lead_contract')
            vm.$nextTick(() => {
