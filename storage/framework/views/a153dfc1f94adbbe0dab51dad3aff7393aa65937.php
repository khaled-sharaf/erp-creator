...
<head>
    ...
    <title>Contract <?php echo e('#0000' . $contract->id); ?> </title>
    <?php echo Html::style('admin/css/pdf/contract.css'); ?>
...
<body>
    ...
    <div class="page-header">
        ...
        <div class="logo">
            <img class="img"
                src="<?php echo e(url('/') . '/' . $settings['logo']); ?>"
    ...
    <section class="wrapper-content">
        <div class="content">
            <!-- ========================================================================== -->
            <h2 class="page-title">
                <b class="label-page">Contract</b> CONT/<?php echo e(date('Y') . '/' . '0000' . $contract->id); ?>
            ...
            <div class="header-content">
                <div class="line">
                    <div class="date-into f-right">
                        إنه فى يوم
                        <b><?php echo e($name_days[date('w', strtotime($contract->created_at))]); ?></b>
                        الموافق
                        <b><?php echo e(date('d-m-Y', strtotime($contract->created_at))); ?></b>
                        م
                        ،
                ...
                <div class="wrapper-header-content">
                    <div class="first-part">
                        ...
                        <div class="wrapper-part">
                            <div class="line">
                                السادة /
                                <b><?php echo e($settings['app_name_long_arabic']); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                ويمثلها فى هذا العقد السيد /
                                <b><?php echo e($contract->personalSales->name_ar); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                بصفته /
                                <b><?php echo e($contract->personalSales->jobTitle->name); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                الرقم القومى /
                                <b><?php echo e($contract->personalSales->id_cart); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                العنوان /
                                <b><?php echo e($contract->personalSales->address); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                الجنسية /
                    ...
                    <div class="second-part">
                        ...
                        <div class="wrapper-part">
                            <div class="line">
                                السادة /
                                <b><?php echo e($contract->lead->company_name); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                ويمثلها فى هذا العقد السيد /
                                <b><?php echo e($contract->lead->name); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                بصفته /
                                <b><?php echo e($contract->job_title_lead); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                الرقم القومى /
                                <b><?php echo e($contract->lead->id_cart); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                               العنوان /
                                <b><?php echo e($contract->lead->company_address); ?></b>.
                            </div>
                            <!-- ======================================== -->
                            <div class="line">
                                الجنسية /
            ...
            <div class="introduction">
                ...
                <div class="line">
                    ...
                    <b><?php echo e($contract->lead->company_name); ?></b>
                    المختصة بمجال
                    <b><?php echo e($contract->lead->company_scope); ?></b>.
                </div>
                <!-- ======================================== -->
                <div class="line">
            ...
            <div class="contract-info">
                <div class="line">
                   حيث أنه يبدأ  فى /
                    <span class="bold main-color"><?php echo e(date('d-m-Y', strtotime($contract->start_date))); ?></span>
                    ، وينتهى فى /
                    <span class="bold main-color"><?php echo e(date('d-m-Y', strtotime($contract->start_date . ' + '. $contract->duration .' month - 1 day'))); ?></span>
                    ،
                    ومدة التجديد كل /
                    <span class="bold main-color">
                        <?php echo e($contract->duration > 1 ? $contract->duration : ''); ?>

                        <?php echo e($contract->duration > 10 || $contract->duration < 2 ? 'شهر' : 'شهور'); ?>
            ...
            <div class="terms">
                ...
                <!-- ======================================== -->
                <?php $__empty_1 = true; $__currentLoopData = $contract->terms()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="line">
                        <span class="line-number"><?php echo e('بند ' . ($key + 13)); ?></span> -
                        <?php echo e($term->content); ?>
...
<?php /**PATH /home/o81ha81bwxnl/public_html/erp.creatoreg.com/project/resources/views/pdf/contract/contract.blade.php ENDPATH**/ ?>